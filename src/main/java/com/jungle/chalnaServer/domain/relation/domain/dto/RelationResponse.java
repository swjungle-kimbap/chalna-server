...
public record RelationResponse(Long id,Long otherId,FriendStatus friendStatus, boolean isBlocked, Integer overlapCount) {
    public RelationResponse of(Relation relation){
